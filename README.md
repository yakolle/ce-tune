...
num_round = 1128
origin_params = {'objective': 'binary', 'metric': 'auc', 'verbose': -1, 'nthread': 4, 'num_boost_round': num_round,
...
init_param = [('learning_rate', 0.00875), ('num_leaves', 20), ('max_depth', 8), ('min_data', 1187),
              ('bagging_fraction', 0.9), ('feature_fraction', 0.5), ('lambda_l1', 32.0), ('lambda_l2', 0.45875)]
...
tune(lgb_model, (train_x, train_y), init_param, param_dic, measure_func=metrics.roc_auc_score, detail=True,
     data_dir=data_dir, kc=(3, 1), score_min_gain=1e-4, random_state=853, task_id='porto_lgb_select', 
     non_ordinal_factors=['max_depth'])
```
